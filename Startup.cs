...
namespace Taxi_Booking_API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddCors();//cors: add this to consume api
            services.AddDbContext<BookingContext>(opt =>
                                              opt.UseInMemoryDatabase("TaxiBooking"));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Taxi_Booking_API v1"));
            }
